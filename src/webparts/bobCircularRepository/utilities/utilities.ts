...
export default class utilities {
     ...
     * GetFileImageUrl
     */
    public GetFileImageUrl(_file: IAttachmentFile): Promise<string> {
        let _fileImageUrl: string = DOCICONURL_GENERIC;
        // const _fileTypes = _file.FileName.split('.');
        const _fileTypes = _file.name.substring(_file.name.lastIndexOf(".") + 1, _file.name.length);
        const _fileExtension = _fileTypes;
    ...
    public GetAttachmentImageUrl(_file: IAttachmentFile): string {
        let _fileImageUrl: string = DOCICONURL_GENERIC;
        // const _fileTypes = _file.FileName.split('.');
        const _fileTypes = _file.name.substring(_file.name.lastIndexOf(".") + 1, _file.name.length);
        const _fileExtension = _fileTypes;
        // const _fileTypes = _file.name.split('.');
    ...
    public IsStringNullOrEmpty(value: string) {
    ...
    public GetQueryStringParameter(queryString: string): string {
        let itemRequestID = '';
        if (!this.IsStringNullOrEmpty(queryString)) {
